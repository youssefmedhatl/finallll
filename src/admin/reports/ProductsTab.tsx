...
export function ProductsTab() {
  ...
  const sortValue = (row: ProductPerf & { margin: number }): number => {
    switch (sortKey) {
      case 'margin':
        return row.margin
      case 'units_sold':
        ...
        <Table>
          <THead>
            <TR>
              ...
              <SortHeader label={t('reports.unitsSold')} sortField="units_sold" />
              <SortHeader label={t('orderDetail.lineTotal')} sortField="revenue" />
              <SortHeader label={t('reports.cost')} sortField="cost" />
              <SortHeader label={t('reports.profit')} sortField="profit" />
              <SortHeader label={t('reports.margin')} sortField="margin" />
              <SortHeader label={t('orderDetail.returned')} sortField="units_returned" />
            </TR>
          </THead>
          <TBody>
            {sorted.map((row) => {
