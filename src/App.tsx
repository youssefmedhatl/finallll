    ...
    <div className="flex items-center justify-center min-h-screen bg-bone px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <h1 className="mb-2 text-3xl font-bold text-ink display">
            Vitaly
          </h1>
        ...
        >
          ...
          {!isSignUp && (
            <p className="text-xs text-moss italic">
    ...
    <Suspense fallback={<RouteFallback />}>
      <Routes>
        ...
        >
          ...
          {/* Hidden for this build — see the matching commented import above
